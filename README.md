...
This comes particularly useful for cloud instances that do not use static IPs (an AWS EC2 cloud-init example is given below) or alternatively to access home computers connected to the Internet via broadband, assuming port-forwarding is configured for the relevant ports (ie. 80, 443, 22, ...).
